    ...
    <img src="images/woman.jpeg" >
        ...
        <div class="box4">
            ...
            <div class="box2">
                ...
                <div class="box3">
                    <img src="images/investment.png" style="width:500px;height:500px;">
                </div>
                <div class="box5">
...
if (isset($_POST['save'])) {
  ...
  $sql = "INSERT INTO investmentform (name,surname,email,phone,subject)
  ...
  mysqli_close($con);
  echo "<script>alert('Successfully Added!!!'); window.location='./investment.php'</script>";
}
?>
