...
<body class="loggedin">
    ...
    <div class="content">
		...
		<button type="button" class="close" data-dismiss="alert">
		<a href="../loans/index.php"><i class="fas fa-newspaper"></i>Loans-Form</a>
		</button>
		<button type="button" class="close" data-dismiss="alert">
			<a href="./index.php"><i class="fas fa-newspaper"></i>Investment-Form</a>
		</button>
		<button type="button" class="close" data-dismiss="alert">
        ...
        <div class="content-1">
            ...
            <table cellpadding="0" cellspacing="0" border="1" class="table table-striped table-bordered" id="example">
                ...
                <tbody>
                    <?php
                    require_once('../../db.php');
                    $result = $conn->prepare("SELECT * FROM investmentform ORDER BY id DESC");
                    $result->execute();
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:center; word-break:break-all;"><a href=" delete-investment.php?id=<?php echo $row["id"]; ?>"><i class="far fa-trash-alt"></i></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
